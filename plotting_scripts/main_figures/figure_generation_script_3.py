...
def compare_cell_properties(cell_stats, fig, axs_rmp, axs_inr,
    ...
    # Plot Resting Membrane Potential (RMP) with Violin Plot using bpf colors
    g1 = sns.violinplot(
    ...
    if not cell_stat_with_category_inpR_filtered.empty:
        # Plot Input Resistance (InputR) with Violin Plot using bpf colors
        g2 = sns.violinplot(
